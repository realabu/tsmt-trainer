...
export class RoutinesService {
  constructor(
    ...
    private readonly routineDeleteImpactService: RoutineDeleteImpactService,
  ) {}
  ...
  async getDeleteImpact(currentUser: AuthenticatedUser, routineId: string) {
    return this.routineDeleteImpactService.getDeleteImpact(currentUser, routineId);
  }
  ...
  async getTaskDeleteImpact(currentUser: AuthenticatedUser, taskId: string) {
    return this.routineDeleteImpactService.getTaskDeleteImpact(currentUser, taskId);
  }
  ...
  async getPeriodDeleteImpact(currentUser: AuthenticatedUser, periodId: string) {
    return this.routineDeleteImpactService.getPeriodDeleteImpact(currentUser, periodId);
  }
